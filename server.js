...
const possiblePaths = [
    ...
    path.join(os.homedir(), 'kentscript.py'),                                // Home directory
    ...
    for (const possiblePath of possiblePaths) {
        ...
        try {
            if (fs.existsSync(possiblePath)) {
                // Check if readable
                fs.accessSync(possiblePath, fs.constants.R_OK);
                console.log(`✅ Found KentScript at: ${possiblePath}`);
                return possiblePath;
            }
        } catch (err) {
